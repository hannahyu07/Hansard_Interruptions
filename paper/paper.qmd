...
#| message: false
model2 <-
  readRDS(file = here::here("C:/Users/35911/Downloads/Hansard_Interruptions/models/model2.rds"))
...
top_topics_per_year %>%
  ...
  tab_header(
    ...
    subtitle = "Extracted from Parliamentary Speeches (1998-2022)"
  ) %>%
  cols_label(
    Year = "Year",
...
ggplot(tracked_topics, aes(x = Year, y = Count, color = Cleaned_Keywords, group = Cleaned_Keywords)) +
  ...
  labs(title = "Mentions of Key Topics Over Time",
       x = "Year",
       y = "Count of Mentions",
